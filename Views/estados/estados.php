        ...
        <main class='page'> 
            ...
            <section class='card'> 
                ...
                <form id='estado-form'> 
                    ...
                    <div class='actions'> 
                        <button type='submit' class='btn primary' id='submit-btn'><span class='btn-icon'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='M17 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V7l-4-4zm-5 16a3 3 0 1 1 0-6 3 3 0 0 1 0 6zm3-10H5V5h10v4z' fill='currentColor'></path></svg></span><span class='btn-label'>Guardar estado</span></button> 
