...
$esAdmin = $idRol === 1;
$ruta = (string) ($_GET['r'] ?? '');
$mostrarCerrarSesionBarraLateral = !in_array($ruta, ['tickets', 'perfil'], true);

function iconoBarraLateral(string $nombre): string
{
    $iconos = [
        'inicio' => "<svg viewBox='0 0 24 24' aria-hidden='true'><path d='M12 3 3 10v11h6v-7h6v7h6V10l-9-7z' fill='currentColor'></path></svg>",
        ...
        'cerrar_sesion' => "<svg viewBox='0 0 24 24' aria-hidden='true'><path d='M10 17v-3H3v-4h7V7l5 5-5 5zm4-12h5v14h-5v2h7V3h-7v2z' fill='currentColor'></path></svg>",
    ];
