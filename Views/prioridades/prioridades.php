<!-- Este archivo PHP define la vista de gestión de prioridades del sistema.
     Renderiza el listado y las acciones CRUD para administrar niveles de prioridad. -->
<!DOCTYPE html>
<html lang='es'> 
<head> 
    <meta charset='UTF-8'> 
 ...
 <link rel='stylesheet' href='/NexoTI/Views/partials/app-shell.css'>
    ...
    <script src='/NexoTI/Views/prioridades/prioridades.js?v=3' defer></script>
</head>
<body> 
    <div class='layout'> 
